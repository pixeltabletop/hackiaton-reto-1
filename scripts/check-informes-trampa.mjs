/**
 * Puerta de los informes trampa. Pasa cada informe de `src/data/trampas.ts` por el
...
const ARCHIVO = 'src/data/trampas.ts';
const fuente = readFileSync(new URL(`../${ARCHIVO}`, import.meta.url), 'utf8').split('\n');
...
console.log(
  estricto
    ...
    : `\nCHECK TRAMPAS: OK — ninguna regresión; ${deudaVigente.length} en deuda (npm run check:trampas -- --estricto exige cero)`,
);
